<?php
    ...
    if(isset($_POST["btn"]))
    {
        ...
        $sql = "INSERT INTO assignment(ASSID,AName,Subject,fl) VALUES('$ASSID','$AName','$Subject','$i')";
                     ...
                     <div class="title">Upload</div>
                        <form method="post" enctype="multipart/form-data">
                            <div class="user-details">
                                <div class="input-box">
                                    <span class="details">Assignment No.</span>
                                    <input type="text" name="ASSID" id="" placeholder="Project Number">
                                </div>

                                <div class="input-box">
                                    <span class="details">Assignment Name</span>
                                    <input type="text" name="AName" id="" placeholder="Enter Project Name">
