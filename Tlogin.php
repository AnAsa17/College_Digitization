<?php
    ...
    if(isset($_POST["tlogin"]))
    {
        ...
        $sql = "SELECT * FROM teacher where TID='$TID' and  TPassword='$TPassword'";
        //echo $sql;exit;
...
<body>
    <div id="main">
        ...
        <div class="two">
            ...
            <div class="">
            <!-- <a href="Slogin.php" class="btn btn-info" role="button" style="margin-left: 180px;">STUDENT</a> 
                <a href="Tlogin.php" class="btn btn-info" role="button" style="margin-left: 30px;">PROFESSORS</a> 
                <a href="Alogin.php" class="btn btn-info" role="button" style="margin-left: 30px;">ADMIN</a>  -->
                ...
                <form method="post">
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input type="text" name="TID" id="" placeholder="Teacher ID" required >
                        </div>

                        <div class="input-box">
                            <!-- <span class="details">Teacher ID</span> -->
                            <input type="password" name="TPassword" id="" placeholder="Password" required >
                        </div>
